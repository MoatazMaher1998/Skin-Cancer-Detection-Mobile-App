                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () async {
                      if (_formKey.currentState.validate()) {
                        debugPrint("SUCCESS + ${emailController.text} + ${nameController.text} + ${passwordController.text} + ${confirmPasswordController.text} + ${DOBController.text} + $genderController");
                        try{
